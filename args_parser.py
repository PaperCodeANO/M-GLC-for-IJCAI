...
def args_parser():
    ...
    # selector
    parser.add_argument("--pool_num", default=5, type=float)
    ...
    parser.add_argument("--use_norm_loss", default=1, type=int)
    parser.add_argument("--norm_w", default=1.0, type=float)

    # New
    parser.add_argument("--motif_num", default=500, type=int)
    parser.add_argument("--use_motif_node", action="store_true", default=False)
    parser.add_argument("--context_norm", choices=["a", "b"], type=str, default="a", help="Select norm strategy: a - baseline, b - norm all")
    parser.add_argument("--use_subgraph", action="store_true", default=False)
    parser.add_argument("--start_eval_episode", default=0, type=int)
